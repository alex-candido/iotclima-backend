...
INSTALLED_APPS = [
    ...
    'django_app.modules.v1.events',
    'django_app.modules.v1.logs',
]
...
REST_AUTH = {
    ...
    'USER_DETAILS_SERIALIZER': config.REST_AUTH_USER_DETAILS_SERIALIZER,
    'REGISTER_SERIALIZER': 'django_app.modules.v1.auth.serializers.CustomRegisterSerializer',
}
