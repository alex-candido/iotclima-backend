...
class SensorsViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        serializer = SensorsOutputSerializer(page, many=True)
    ...
    def update(self, request, pk=None):
        ...
        input_data = self._validated_data(SensorsInputSerializer, data=request.data, instance=instance, partial=False)
